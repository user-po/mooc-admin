<template>
  <div class="user-manage">
    <div class="query-form">
      <el-form ref="form" :inline="isinLine" :model="queryForm">
        <el-form-item label="菜单名称" prop="menuName">
          <el-input v-model="queryForm.menuName" placeholder="请输入菜单名称" />
        </el-form-item>
        <el-form-item label="" prop="menuState">
      ...
      >
        ...
        <el-table-column label="操作" width="220">
          <template #default="scope">
            <el-button size="mini" @click="handleAdd(2,scope.row)" type="primary"
              >新增</el-button
            >
       ...
       <el-dialog :title="title" v-model="showModal" :before-close="handleClose">
     <el-form
        ref="dialogForm"
        :model="menuForm"
        label-width="100px"
